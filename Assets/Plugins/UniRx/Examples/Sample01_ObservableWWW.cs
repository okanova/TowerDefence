    ...
    public class Sample01_ObservableWWW : MonoBehaviour
    {
        void Start()
        {
            ...
            // download after google, start bing download
            {
                ...
                var cancel = query.UniSubscribe(x => Debug.Log(x.google.Substring(0, 100) + ":" + x.bing.Substring(0, 100)));
            ...
            // with Progress
            {
                ...
                progressNotifier.UniSubscribe(x => Debug.Log(x)); // write www.progress

                // pass notifier to WWW.Get/Post
                ObservableWWW.Get("http://google.com/", progress: progressNotifier).UniSubscribe();
            }
